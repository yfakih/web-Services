 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://server/", wsdlLocation = "http://localhost:8083/?wsdl")
    ...
    extends Service
{
     ...
     *     returns BancService
     */
    @WebEndpoint(name = "BancServicePort")
    public BancService getBancServicePort() {
        return super.getPort(new QName("http://server/", "BancServicePort"), BancService.class);
    }
     ...
     */
    @WebEndpoint(name = "BancServicePort")
    public BancService getBancServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server/", "BancServicePort"), BancService.class, features);
    }
